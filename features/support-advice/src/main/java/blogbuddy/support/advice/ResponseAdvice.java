package blogbuddy.support.advice;


import blogbuddy.support.advice.result.CommonResult;
import blogbuddy.support.advice.result.SearchResult;
import blogbuddy.support.advice.result.SingleResult;
